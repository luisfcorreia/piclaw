export function buildDreamPrompt(options?: { mode?: "manual" | "auto"; days?: number }): string {
  ...
  return [
    ...
    "- Keep `notes/memory/current-state.json` and `notes/memory/recent-context.md` aligned with your final consolidated state.",
    ...
    "- Keep `notes/daily/*.agent.json` aligned with any changed daily notes.",
