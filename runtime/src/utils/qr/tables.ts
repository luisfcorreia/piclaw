/**
 * utils/qr/tables.ts – Static QR encoding lookup tables.
 */

/** Reed-Solomon block layout table indexed by QR type and error-correction level. */
export const QR_RS_BLOCK_TABLE: number[][] = [
...
/** Position-adjustment coordinate table indexed by QR type number. */
export const QR_PATTERN_POSITION_TABLE: number[][] = [
