...
let requestBackgroundWorkspaceIndexRefreshImpl = (params = {}) => {
...
function shouldAggressivelyReleaseWorkspaceIndexMemory() {
    return process.env[AGGRESSIVE_WORKSPACE_INDEX_MEMORY_ENV] === "1";
}
function aggressivelyReleaseWorkspaceIndexMemory() {
    if (!shouldAggressivelyReleaseWorkspaceIndexMemory())
        return;
    try {
...
export function requestBackgroundWorkspaceIndexRefresh(params) {
    requestBackgroundWorkspaceIndexRefreshImpl(params || {});
}
export function setBackgroundWorkspaceIndexRefreshRequesterForTests(requester) {
    requestBackgroundWorkspaceIndexRefreshImpl = requester ?? ((params = {}) => {
        void import("./workspace-index-process.js")
            .then((mod) => {
            mod.launchWorkspaceIndexProcess({ scope: params.scope, max_kb: params.max_kb });
        })
