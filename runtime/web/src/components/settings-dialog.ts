...
const iconGeneral = html`<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M10.5 2.1L10 4.5a8 8 0 0 0-2.8 1.6L4.8 5.2 3.2 7.9l2 1.6a8 8 0 0 0 0 3l-2 1.6 1.6 2.7 2.4-.9a8 8 0 0 0 2.8 1.6l.5 2.4h3l.5-2.4a8 8 0 0 0 2.8-1.6l2.4.9 1.6-2.7-2-1.6a8 8 0 0 0 0-3l2-1.6-1.6-2.7-2.4.9A8 8 0 0 0 14 4.5l-.5-2.4z"/></svg>`;
