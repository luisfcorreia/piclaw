...
function normalizeHostForLookup(hostname) {
...
function isBlockedHostname(hostname) {
    ...
    if (lower === "localhost" || lower.endsWith(".localhost"))
        return true;
    if (lower.endsWith(".local") || lower === "0.0.0.0")
        return true;
...
export async function validateCallbackUrl(raw, resolveHost = defaultResolveHost) {
