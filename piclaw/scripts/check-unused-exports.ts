...
const ALLOWED_UNUSED_EXPORTS = new Set([
  ...
  "src/db.ts:99 - DEFAULT_PASSKEY_USER_ID",
  "src/db.ts:115 - deleteWebSession",
  "src/db.ts:119 - ChatInfo",
  "src/db.ts:121 - InteractionContentMeta",
  "src/db.ts:122 - InteractionData",
  "src/db.ts:124 - MediaRecord",
  "src/db.ts:50 - getTaskRunLogs",
  "src/db.ts:56 - deleteToolOutputById",
  "src/db.ts:78 - FailedRunRecord",
  "src/db.ts:86 - upsertRemotePeer",
  "src/db.ts:87 - getRemotePeer",
  "src/db.ts:88 - updateRemotePeer",
  "src/db.ts:89 - createPairRequest",
  "src/db.ts:90 - getPairRequestById",
  "src/db.ts:91 - getPendingPairRequest",
  "src/db.ts:92 - updatePairRequestStatus",
  "src/db.ts:93 - storeRemoteRequest",
  "src/db.ts:94 - updateRemoteRequest",
  "src/db.ts:95 - getRemoteRequestById",
  "src/db.ts:96 - logRemoteAudit",
  ...
  "src/task-scheduler.ts:75 - getSchedulerMetrics",
  "src/task-scheduler.ts:80 - resetSchedulerMetricsForTests",
