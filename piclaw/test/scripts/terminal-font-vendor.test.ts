...
function buildTerminalFonts() {
  return Bun.spawnSync(
    ["bun", "/workspace/piclaw/piclaw/scripts/vendor-firacode-nerd-font.ts"],
    {
...
test("terminal font workflow vendors FiraCode Nerd Font Mono with metadata", () => {
  ...
  const metaFile = "/workspace/piclaw/piclaw/web/static/fonts/vendor/firacode-nerd-font.meta.json";
  const regularFile = "/workspace/piclaw/piclaw/web/static/fonts/vendor/firacode-nerd-font-mono-regular.ttf";
  const boldFile = "/workspace/piclaw/piclaw/web/static/fonts/vendor/firacode-nerd-font-mono-bold.ttf";
